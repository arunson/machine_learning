...
trainingFileName='target/rec_log_train_targetUser.txt'
trainingOutputFileName='train_finalist.csv'
...
def convertTrainingSet(userInfoDict, trainingIdSet):
	itemInfoDic = getNumOfFollowers('../track1/target/itemAnditsFollowers.txt')
